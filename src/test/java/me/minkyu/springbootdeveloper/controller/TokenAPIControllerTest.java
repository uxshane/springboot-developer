...
import me.minkyu.springbootdeveloper.config.jwt.JwtFactory;
import me.minkyu.springbootdeveloper.config.jwt.JwtProperties;
...
class TokenAPIControllerTest {
    ...
    @DisplayName("createNewAccessToken: 새로운 엑세스 토큰을 발급 성공한다")
    @Test
